...
BASE = BACKEND_DIR / 'classification_dataset'
train_dir = BASE / 'train'
valid_dir = BASE / 'valid'
test_dir = BASE / 'test'

out_dir = BACKEND_DIR / 'reports' / 'results_dummy'
...
filled_report_path = BACKEND_DIR / 'reports' / 'model_comparison_report_filled.md'
